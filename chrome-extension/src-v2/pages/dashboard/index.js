...
function loadDashboardContent(userData) {
    ...
    try {
        ...
        dashboardCard.addCard('Account Summary', `
        ...
        // Add API Tester card
        dashboardCard.addCard('API Tester', `
            <p>Test the LinkedIn Gateway API endpoints directly from the extension.</p>
        `, {
            actions: [
                {
                    text: 'Open API Tester',
                    primary: true,
                    onClick: () => {
